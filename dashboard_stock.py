...
def dashboard_thread():
  ...
  influxFormatString = user_id + ",sources=capnp ff_standard=;angle_steers_des=;angle_steers_des1=;angle_steers_des2=;angle_steers_des3=;steer_output=;steer_output1=;steer_output2=;steer_output3=;angle_steers=;steer_override=;v_ego=;p=;i=;f=;cumLagMs=; "
  influxDataString = ""
      ...
      if socket is live100:
        ...
        for l100 in _live100:
          ...
          if vEgo > 0:
            ...
            influxDataString += ("%d,%0.4f,%0.4f,%0.4f,%0.4f,%0.4f,%0.4f,%0.4f,%0.4f,%0.2f,%d,%0.1f,%0.4f,%0.4f,%0.4f,%0.2f,%d|" %
                (1.0, l100.live100.desAngle[0], l100.live100.desAngle[1], l100.live100.desAngle[2], l100.live100.desAngle[3], l100.live100.steerOutput[0],
                l100.live100.steerOutput[1], l100.live100.steerOutput[2], l100.live100.steerOutput[3], l100.live100.angleSteers, l100.live100.steerOverride, vEgo,
